...
namespace hayai
{
    /// std::random_shuffle has been removed in C++17. This placeholder was 
    /// copied from http://en.cppreference.com/w/cpp/algorithm/random_shuffle.
    ...
    public:
        ...
        {
            Benchmarker& instance = Instance();
            random_shuffle(instance._tests.begin(),
                           instance._tests.end());
        }
    private:
        /// Calibration model.
